DCR Comic: a visual guide to Decred - Season 2

# DCR Comic - Season 2

**Updated: added new characters section to address Stakey's overuse.**
...
For **Season 2**, we intent to produce **12 more comics**, this time focusing not only on specific Decred technology but also on **the broader problems Decred aims to solve**. We are targeting larger audience, and we intent to keep expanding our public as the project evolves. After feedback from the design team on not over using Stakey, we have decided to create different characters to explain the Decred ecosystem, and redesign some aspects of the comic to bring it closer to the DCR design system.
...
After receiving several comments about overusing Stakey, we have decided to create new characters (included in the images below) to explain different aspects of the Decred ecosystem. These include:
- Hash-9, the loyal miner dog
- Holdee, the privacy concerned wallet
- Atom, the coin (introduced in the 7th comic)
- Centris, the game rigger, our first villain
- The Candlestonk Family, representing the market/traders

This are not fully developed and will continue to be defined as we make the new comics, but we think this is a good starting point in order to avoid Stakey's overuse and bring more depth to the DCR Comic universe. The current state of the characters can be found [here](https://github.com/pLabarta/dcrwebcomic/blob/master/Proposal2/NewChars.md).
