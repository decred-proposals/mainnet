Grassroots Marketing - growing Decred community (withDecred.org)

According to the preferences of wider community, this is a bottom-up effort of several people from the community. The goal of this effort is to find scalable approach to onboard new users to Decred through education, awareness, gamification and network effects.

## Context

In today's world with information being pushed from all angles, people's attention span in the online space can be just minutes, sometimes even just seconds. Providing the right amount of information with a combination of gamification and/or network effects can raise people's attention with goal to the get the desired information across.
...
We believe that we need to find a scalable approach to onboarding new users to Decred community by applying proven strategies to find which one will yield scalable results.
...
*"We are celebrating release of private staking. Earn $50 USD in $DCR by helping people learn about Decred private staking. Follow @decredproject and @withDecred, download Decrediton wallet and post screenshot of you wallet address below."*

*"We are celebrating release of Lightning Network (LN). We will pick 5 random people who retweet this and send them a Lightning Torch worth $10 via LN. We encourage people to pass it forward. Post screenshot of your Decrediton LN wallet address in comment."*
...
We are also asking for for a additional $297 USD per month for following:
